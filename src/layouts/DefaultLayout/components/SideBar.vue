<template>
  <div>
    <div class="ant-layout-sider-children">
      ...
      <div>
        <a-menu :openKeys="openKeys" @openChange="onOpenChange" :defaultSelectedKeys="['/analysis']" :defaultOpenKeys="['/dashboard']" mode="inline" theme="light" :inlineCollapsed="collapsed">
            ...
            <a-sub-menu v-else :index="item.name || item.path" :key="item.path">
              ...
              <template v-for="child in item.children" v-if="!child.hidden">
                <a-menu-item :key="child.path">
                  <router-link v-if="item.children" :to="item.path + child.path" :key="child.name">
                    {{child.name}}
                  </router-link>
                </a-menu-item>
              </template>
